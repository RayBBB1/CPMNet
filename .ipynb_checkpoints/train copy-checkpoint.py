...
def get_args():
    ...
    parser.add_argument('--batch_size', type=int, default=4, help='input batch size for training (default: 6)')
    ...
    parser.add_argument('--train_set', type=str,default=r'D:\Jack\Me_dataset_dicom_resize_npy\train\data_list_crop.txt', help='train_list')
    parser.add_argument('--val_set', type=str,default=r'D:\Jack\Me_dataset_dicom_resize_npy\val\data_list_crop.txt', help='val_list')
    parser.add_argument('--test_set', type=str,default=r'D:\Jack\Me_dataset_dicom_resize_npy\test\data_list_crop.txt', help='test_list')
    ...
    parser.add_argument('--use_itk_rotate', action='store_true', default=true, help='use itk rotate')
    ...
    parser.add_argument('--ema_warmup_epochs', type=int, default=120, help='warmup epochs for ema')
    # Loss hyper-parameters
    parser.add_argument('--loss_class', type=str, default='networks.gfocal_loss', help='loss class')
    ...
    parser.add_argument('--num_samples', type=int, default=4, help='number of samples for each instance')
    ...
    parser.add_argument('--lambda_iou', type=float, default=6.0, help='weights of iou loss')
    # Val hyper-parameters
    parser.add_argument('--det_post_process_class', type=str, default=r'networks.detection_post_process_gfocal')
    ...
    parser.add_argument('--val_fixed_prob_threshold', type=float, default=0.5, help='fixed probability threshold for validation')
    parser.add_argument('--val_det_threshold', type=float, default=0.1, help='detection threshold')
    parser.add_argument('--froc_det_thresholds', nargs='+', type=float, default=[0.1, 0.2, 0.4], help='froc det thresholds')
    ...
    parser.add_argument('--test_det_threshold', type=float, default=0.1, help='detection threshold for test')
    parser.add_argument('--test_froc_det_thresholds', nargs='+', type=float, default=[0.1, 0.2, 0.4], help='froc det thresholds')
    # Model
    parser.add_argument('--model_class', type=str, default='networks.ResNet_3D_CPM_fpn_lessHard_noX4_gfocal_head2_test', help='model class')
    ...
    parser.add_argument('--exp_name', type=str, default='gfocal_loss2', metavar='str', help='experiment name')
