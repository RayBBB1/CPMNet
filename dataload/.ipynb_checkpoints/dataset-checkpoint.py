...
from .utils import load_series_list, load_image, load_label, load_label_with_newTP, load_lobe, gen_additation_label_path, ALL_RAD, ALL_LOC, ALL_CLS, gen_dicom_path, gen_label_path, \
                    gen_lobe_path, normalize_processed_image, normalize_raw_image, gen_additation_label_path
...
class TrainDataset(Dataset):
    ...
    def __init__(self, series_list_path: str, image_spacing: List[float], transform_post=None, crop_fn=None, 
        ...
        for folder, series_name in self.series_infos:
            ...
            additation_path = gen_additation_label_path(folder, series_name, additation_names)
           
            # label = load_label(label_path, self.image_spacing, min_d, min_size)
            label = load_label_with_newTP(label_path, additation_path, self.image_spacing, min_d, min_size)
