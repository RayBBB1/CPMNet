...
def gen_label_path(folder: str, series_name: str) -> str:
    ...
    # LN
    return os.path.join(r'/root/notebooks/groups/BME/LN_dataset', f'{series_name}/mask/{series_name}_nodule_count.json')
...
def load_series_list(series_list_path: str) -> List[List[str]]:
    ...
    for series_info in lines:
        ...
        # LN
        series_list.append([r'/root/notebooks/groups/BME/LN_dataset', series_info])
    return series_list
