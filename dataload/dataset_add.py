...
class TrainDataset(Dataset):
    ...
    def __init__(self, series_list_path: str, image_spacing: List[float], transform_post=None, crop_fn=None, 
        ...
        for folder, series_name in self.series_infos:
            ...
            additation_names = ['hardFP0', 'hardFP125', 'hardFP250', 'hardFP500', 'hardFP1000']
            additation_pathes = gen_additation_label_path(folder, series_name, additation_names)
           
            # label = load_label(label_path, self.image_spacing, min_d, min_size)
            label = load_label_with_newTP(label_path, additation_pathes, self.image_spacing, min_d, min_size)
